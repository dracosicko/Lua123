game.StarterGui:SetCore("SendNotification",  {
 ...
 Icon = "";
 Duration = 4;
 Button1 = "mentality on top";
 Button2 = "fuck u nigga";
 Button3 = "Fuck Off";
 Callback = NotificationBindable;
}
)
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local Window = Library.CreateLib("mentality", colors)
local Tab = Window:NewTab("Scripts")
local Section = Tab:NewSection("Popular Scripts")

Section:NewButton("Infinite Yield", "loads infiniteyield", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'))()
end)

Section:NewButton("beamedware.cc (DA HOOD)", "loads beamedware.cc", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/RYZZCHIPSX/ryzzchips/main/beamed%20ware%20script"))();
end)

Section:NewButton("Working Antilock [B]", "loads working antilock for all executors", function()
    loadstring(game:HttpGet("https://pastebin.com/Xd8V2EUh"))();
end)

Section:NewButton("CMD-Y", "....", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/quivings/KAH/main/CMD-Y%20(v1.56).lua"))()
end)

local Tab = Window:NewTab("Player")
local Section = Tab:NewSection("Things for you")

Section:NewButton("Fly [X]", "flying script, press x to toggle", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/sUA9m6M6"))()
end)

Section:NewButton("No-Recoil", "self explanatory xd", function()
...
Section:NewButton("Q To TP", "uhh excuse me nigga?", function()
    loadstring(game:HttpGet(('https://pastebin.com/raw/qyww70GR'),true))()
end)

Section:NewButton("Fly for mobile players", "uhh excuse me nigga? x3", function()
...
Section:NewButton("Chat Logs", "uhh excuse me nigga? x4 (i ran out of descriptions)", function()
    loadstring(game:HttpGet("https://pastebin.com/raw/nzXicwc1", true))()
end)

Section:NewButton("Click to sit", "uhh excuse me nigga? x5", function()
    game.Players.LocalPlayer.Character.Humanoid.Sit = true
end)


local Tab = Window:NewTab("Combat")
local Section = Tab:NewSection("Aiming nd shit")

Section:NewButton("Smooth Camlock [Q]", "uhh excuse me nigga? x6", function()
...
Section:NewButton("Lorix Aimlock", "uhh excuse me nigga? x4 (i ran out of descriptions)", function()
...
local Section = Tab:NewSection("FE Avatar animations")

Section:NewButton("Mage", "idk", function()
...
Section:NewButton("Cartoony", "idk", function()
    local Animate = game.Players.LocalPlayer.Character.Animate
...
Section:NewButton("Ninja", "idk", function()
    local Animate = game.Players.LocalPlayer.Character.Animate
...
Section:NewButton("Bubbly", "idk", function()
    local Animate = game.Players.LocalPlayer.Character.Animate
...
Section:NewButton("Zombie", "idk", function()
    local Animate = game.Players.LocalPlayer.Character.Animate
...
Section:NewButton("Robot", "idk", function()
    local Animate = game.Players.LocalPlayer.Character.Animate
...
Section:NewButton("Stylish", "idk", function()
    local Animate = game.Players.LocalPlayer.Character.Animate
...
Section:NewButton("Toy", "idk", function()
    local Animate = game.Players.LocalPlayer.Character.Animate
...
Section:NewButton("Astronaut", "idk", function()
    local Animate = game.Players.LocalPlayer.Character.Animate
...
Section:NewButton("Oldschool", "idk", function()
    local Animate = game.Players.LocalPlayer.Character.Animate
...
local Section = Tab:NewSection("made by @5drc")

local Tab = Window:NewTab("UI Customizer")
...
Section:NewColorPicker("Color", "Color Info", Color3.fromRGB(0,0,0), function(color)
    print(color)
